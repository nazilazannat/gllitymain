    	...
    	<div class="container py-4">
                    ...
                    <h2 class="mb-0">Blood Inquiry</h2>
	    				<form action="{{url('saveblood')}}" method="POST" class="appointment bg-white p-4 p-md-5">
				    		...
				    		<div class="form-field">
		          			<div class="select-wrap">
                            <input type="date" name="data" placeholder="Date" class="form-control @error('data') is-invalid @enderror" required>
                            @error('data')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
				    		...
				    		<div class="form-field">
		          			<div class="select-wrap">
                            <input type="text" name="hospital_name" placeholder="Hospital Name" class="form-control @error('hospital_name') is-invalid @enderror" required>
                            @error('hospital_name')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
				    		...
				    		<div class="form-field">
		          			<div class="select-wrap">
                            <input type="text" name="amount" placeholder="How Many Bag Needed" class="form-control @error('amount') is-invalid @enderror" required>
                            @error('amount')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
				    		...
				    		<div class="form-field">
		          			<div class="select-wrap">
                            <input type="text" name="problem" placeholder="Patient Problem" class="form-control @error('problem') is-invalid @enderror" required>
                            @error('problem')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
				    		...
				    		<div class="form-field">
		          			<div class="select-wrap">
                            <input type="text" name="relationship" placeholder="Paitent Relationship" class="form-control @error('relationship') is-invalid @enderror" required>
                            @error('relationship')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="col-md-6">
                            <div class="form-group">
                            <input type="text" placeholder="Age" class="form-control @error('age') is-invalid @enderror" name="age" required>
                            @error('age')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
